# DadaPluginControlGUI 1.0

> GUI OP per vedere i plugin del server ed eseguire i loro comandi.
...
**DadaPluginControlGUI 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

GUI OP per vedere i plugin del server ed eseguire i loro comandi.

| Field | Value |
| --- | --- |
| Plugin | `DadaPluginControlGUI` |
| Version | `1.0` |
| Category | Custom Server Tool |
| Main class | `it.dadasmp.plugincontrolgui.DadaPluginControlGuiPlugin` |
...
`release/DadaPluginControlGUI-1.0.jar`
